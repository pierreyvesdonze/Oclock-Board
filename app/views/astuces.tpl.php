<main>
    <article>
        ...
        <h3>Astuce <span>#1</span> Souviens-toi...</h3>
        <ul>
            <li>
        ...
        <h3>Astuce <span>#2</span> La p'tite manip GIT qui va bien</h3>
        <p>
            <ul>
                <li>
        ...
        <h3>Astuce <span>#4</span> La fausse manip GIT qui fait mal...</h3>
        <p>
            <ul>
                <li>
        ...
        <h3>Astuce <span>#5</span> Obtenir un terminal Linux sous Windows (BASH)</h3>
        <p>
            <ul>
                <li>
        ...
        <h3>Astuce <span>#6</span> Utiliser BASH depuis VSCODE</h3>
        <p>
            <ul>
                <li>
        ...
        <h3>Astuce <span>#7</span> Un petit générateur de tableau HTML bien pratique</h3>
        <p>
            <ul>
                <li>
